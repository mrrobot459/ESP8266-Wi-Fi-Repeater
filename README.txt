...
This code enables an ESP8266 microcontroller to function as a Wi-Fi repeater. It connects to an existing Wi-Fi network and creates a new extended Wi-Fi network, effectively extending the range of the original network. The ESP8266 operates in both Station Mode (STA) and Access Point (AP) mode simultaneously.

Features

Connects to an Existing Network:

The ESP8266 connects to a primary Wi-Fi network using the provided SSID and Password.
...
NodeMCU, Wemos D1 Mini, or any other ESP8266-based board.
...
Replace Your_Existing_Network_SSID and Your_Existing_Network_Password in the code with your primary Wi-Fi network's credentials.

Replace Extended_Network_SSID and Extended_Network_Password with the desired credentials for the extended network.
...
Ensure the board is powered and detected by your computer.
...
Modify the placeholders with your network credentials.
...
Use another device to connect to the extended network using the Extended_Network_SSID and Extended_Network_Password.
